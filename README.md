...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 김건훈 |:white_check_mark:|:white_check_mark:||||||||||||||
| 김성규 |:white_check_mark:|:white_check_mark:||||||||||||||
| 김예림 |:white_check_mark:|:white_check_mark:||||||||||||||
| 박지수 |:white_check_mark:|:white_check_mark:||||||||||||||
| 이상진 |:white_check_mark:|:white_check_mark:||||||||||||||
| 이영현 |:white_check_mark:|:white_check_mark:||||||||||||||
| 한태현 |:white_check_mark:|:white_check_mark:||||||||||||||
